...
var LoadingSpinner = function (_a) {
    ...
    var _renderSpinnerSection = function () { return (jsxRuntime.jsx(View, __assign({ style: styles$c.loadingSpinnerSectionContainer }, { children: jsxRuntime.jsx("div", { className: "loading-spinner-section" }) }))); };
    var _renderSpinnerPage = function () { return (jsxRuntime.jsx(View, __assign({ style: styles$c.loadingSpinnerPageContainer }, { children: jsxRuntime.jsxs(View, __assign({ style: styles$c.loadingSpinnerPageContent }, { children: [jsxRuntime.jsx("div", { className: "loading-spinner-pages" }), loadingIcon ? (jsxRuntime.jsx("img", { style: styles$c.loadingIcon, src: loadingIcon, alt: '' })) : null] })) }))); };
...
var BottomSheet = function (_a) {
    ...
    if (!visible)
        return null;
    return ReactDOM__default["default"].createPortal(jsxRuntime.jsx("div", __assign({ style: styles$b.backdrop, onClick: onClose }, { children: jsxRuntime.jsxs("div", __assign({ style: styles$b.sheet, onClick: function (e) { return e.stopPropagation(); } }, { children: [jsxRuntime.jsxs("div", __assign({ style: styles$b.header }, { children: [jsxRuntime.jsx("span", __assign({ style: styles$b.title }, { children: title })), jsxRuntime.jsx("button", __assign({ style: styles$b.closeButton, onClick: onClose }, { children: "\u00D7" }))] })), jsxRuntime.jsx("div", __assign({ style: styles$b.content }, { children: children }))] })) })), document.body);
};
...
var TouchableOpacity = function (_a) {
    ...
    return (jsxRuntime.jsx("div", __assign({ onClick: handleOnPress, style: __assign(__assign({}, styles$a.content), style) }, props, { children: children })));
};
...
var CameraModal = function (_a) {
    ...
    var _b = react.useState(null), capturedImage = _b[0], setCapturedImage = _b[1];
    var _c = react.useState(false), isCameraReady = _c[0], setIsCameraReady = _c[1];
    var _d = react.useState(true), isFrontCamera = _d[0], setIsFrontCamera = _d[1];
...
var BottomSheetPhoto = function (_a) {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("input", { type: "file", accept: ".png,.jpg,.jpeg", ref: fileInputRef, onChange: handleFileChange, style: { display: 'none' } }), cameraVisible && (jsxRuntime.jsx(CameraModal, { onClose: function () { return setCameraVisible(false); }, onCapture: function (base64) {
                ...
                ReactDOM__default["default"].createPortal(jsxRuntime.jsx("div", __assign({ style: styles$9.backdrop, onClick: onClose }, { children: jsxRuntime.jsxs("div", __assign({ style: __assign(__assign({}, styles$9.sheet), { paddingBottom: paddingBottom }), onClick: function (e) { return e.stopPropagation(); } }, { children: [jsxRuntime.jsxs("div", __assign({ style: styles$9.header }, { children: [jsxRuntime.jsx("span", __assign({ style: styles$9.title }, { children: title })), jsxRuntime.jsx("button", __assign({ style: styles$9.closeButton, onClick: onClose }, { children: "\u00D7" }))] })), jsxRuntime.jsx("div", __assign({ style: styles$9.content }, { children: bottomSheetData.map(function (val, idx) { return (jsxRuntime.jsx(TouchableOpacity, __assign({ onPress: val.onPress, style: styles$9.contentBottomSheet }, { children: jsxRuntime.jsx(Text, { children: val.title }) }), idx)); }) }))] })) })), document.body)] }));
};
...
var SearchBox = function (_a) {
    ...
    var renderScreen = function () {
        var _a;
        return (jsxRuntime.jsxs(View, __assign({ style: styles$1.searchContainer }, { children: [jsxRuntime.jsx(Text, __assign({ style: styles$1.iconSearch }, { children: "\uD83D\uDD0D" })), jsxRuntime.jsx(TextInput, __assign({ style: styles$1.textInputContainer, styleTextInput: styles$1.textInput, placeholder: placeholder, onKeyPress: function (event) {
                    ...
                    } }, props)), value && (value === null || value === void 0 ? void 0 : value.length) > 0 ? (jsxRuntime.jsx(TouchableOpacity, __assign({ style: styles$1.closeSearchButton, onPress: function () {
                        if (handleOnClearSearch) {
                            handleOnClearSearch();
                        }
                    } }, { children: jsxRuntime.jsx(Images, { style: styles$1.closeSearchButtonImage, src: (_a = Icons.close) !== null && _a !== void 0 ? _a : '' }) }))) : null] })));
    };
    return renderScreen();
};
