...
var LoadingSpinner = function (_a) {
    ...
    var _renderSpinnerSection = function () { return (jsxRuntime.jsx(View, __assign({ style: styles$7.loadingSpinnerSectionContainer }, { children: jsxRuntime.jsx("div", { className: "loading-spinner-section" }) }))); };
    var _renderSpinnerPage = function () { return (jsxRuntime.jsx(View, __assign({ style: styles$7.loadingSpinnerPageContainer }, { children: jsxRuntime.jsxs(View, __assign({ style: styles$7.loadingSpinnerPageContent }, { children: [jsxRuntime.jsx("div", { className: "loading-spinner-pages" }), loadingIcon ? (jsxRuntime.jsx("img", { style: styles$7.loadingIcon, src: loadingIcon, alt: '' })) : null] })) }))); };
...
var Container = function (_a) {
    ...
    return (jsxRuntime.jsx(View, __assign({ style: __assign(__assign({}, styles$6.container), { containerStyle: containerStyle }) }, { children: jsxRuntime.jsx(View, __assign({ style: __assign(__assign({}, styles$6.content), { contentStyle: contentStyle }) }, { children: children })) })));
};
