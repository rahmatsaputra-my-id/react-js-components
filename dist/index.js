...
var TextInput = function (_a) {
    ...
    var stylesTextInput = __assign(__assign(__assign({}, styles$1.textArea), styleTextInput), { borderColor: borderColor, borderRadius: borderRadius, width: '100%', textAlign: center ? 'center' : 'left' });
